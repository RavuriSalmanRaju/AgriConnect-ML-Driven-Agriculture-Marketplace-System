...
// ✅ SHOW ONLY ACTIVE CUSTOMERS + SEARCH (name/phone)
...
<div class="container my-5">
  ...
  <div class="dash-card mb-4">
    <h3 class="fw-bold mb-1">👥 Customers List</h3>
    <p class="text-muted mb-0">Active customers only</p>
  </div>
  ...
  <div class="dash-card mb-3">
    <form class="d-flex" method="GET">
      ...
      <a href="customers_list.php" class="btn btn-outline-dark ms-2">Reset</a>
    </form>
  </div>
