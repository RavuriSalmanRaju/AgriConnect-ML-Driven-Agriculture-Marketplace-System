...
<head>
  ...
  <title>Customer Login | AgriConnect</title>
...
<nav class="navbar agri-navbar py-3">
  <div class="container">
    ...
    <div>
      <a class="small-link" href="register.php">Customer Register</a>
    </div>
  </div>
</nav>
    ...
    <div class="row g-4 align-items-stretch">
      ...
      <div class="col-lg-7">
        <div class="agri-card">
          <div class="agri-card-header">
            <h2 class="agri-title">Customer Login</h2>
            <p class="agri-subtitle">Login to buy fresh crops directly from farmers.</p>
          </div>
      ...
      <div class="col-lg-5">
        <div class="side-panel h-100">
          <span class="badge-pill">Fresh & Direct</span>

          <h5 class="fw-bold mt-3 mb-2">Welcome Back 👋</h5>
          <p class="tip">
            Buy crops directly from farmers with better prices and fresh quality.
          </p>

          <img class="login-img" src="../assets/images/login-farmer.png" alt="Customer Login Image">
